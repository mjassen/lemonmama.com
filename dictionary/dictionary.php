...
//	echo $lang['passwd'].": <input type='password' name='password'/><br/>";
	echo $lang['passwd'].": <input type='password' name='password' value='lcs'/><br/>^^[note: password is 'lcs' and is pre-populated here]<br/>";  //<--- 2020-02-23 - hack -- this pre-populates the password in the form!
